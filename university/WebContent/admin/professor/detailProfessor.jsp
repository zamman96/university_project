...
ProfessorVO pfVo = (ProfessorVO)request.getAttribute("memVO");
							...
							<div id="subjectList">
								<div class="table-wrap">
									<table border="1">
										<tbody>
											<tr>
												<th>단과명</th><th>학과명</th><th>교수명</th><th>생일</th>
												 <th>성별</th><th>주소</th><th>전화번호</th><th>메일</th><th>상세조회</th>
											</tr> 
											...
											%>
												<tr>
													<td><%=memVO.getCol_name() %></td>
													<td><%=memVO.getMajor_name() %></td>
													...
													<td> <input type="button" value="강의내역 조회" onclick="location.href='<%=request.getContextPath()%>/'"> </td>
													<td> <input type="button" value="교수 재직상태 변경" onclick="location.href='/admin/professor/updatePro_type.jsp?pro_id<%=memVO.getPro_id()%>'"> </td>
												</tr>
											<%
												}
											%>
