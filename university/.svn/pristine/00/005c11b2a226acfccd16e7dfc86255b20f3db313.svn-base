...
List<MemberVO> stuList = 
					(List<MemberVO>)request.getAttribute("stuList");
			...
			<section>
				...
				<div class="section-content">
					...
					<div class="section-center">
						...
						<div class="btns">
							<input type="button" value="등록금 납부 학생 목록" onclick="location.href='<%=request.getContextPath()%>/stuTuiList.do'">
							<input type="button" value="등록금 미납 학생 목록" onclick="location.href='<%=request.getContextPath()%>/stuTuiList2.do'">
						</div>
